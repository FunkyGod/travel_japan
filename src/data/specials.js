...
export const specialTopics = [
  ...
  },
  {
    ...
    facts: [
      { label: '最新核查', value: '2026-09-01', note: '对照 JR 集团 / JR 东海 / JR 东日本 / Tokyo Metro / 京都市交通局 / 国税厅 / 首里城公园 / 石川县官方公告' },
      { label: '影响范围', value: '铁路、免税、机场', note: '需要看 JR / 国税厅 / 机场与景区实时公告' },
    ...
    highlights: [
      ...
      { title: '免税改返金方式', body: '2026-11-01 起，消耗品与一般商品的分类合并，退税流程改为返金方式；购物与离境凭证要保留好，具体以国税厅与商店公告为准。' },
    ],
    guides: [
