...
export const specialTopics = [
  ...
  },
  {
    ...
    facts: [
      { label: '最新核查', value: '2026-09-11', note: '对照 JR 九州 / JR 东海 / JR 东日本 / JNTO / 国税厅 / 首里城公园 / 石川县 / 日本气象协会官方公告' },
      { label: '影响范围', value: '铁路（白银周+10/1 调价）、红叶、免税、机场', note: '⚠️ 本周新增：白银周预订窗口 / 红叶前线 9 月更新 / JR Pass 10/1 调整临近' },
      { label: '更新频率', value: '每周一次（本周维护：2026-09-11）', note: '每周维护与重新对照官方信息' },
    ],
    highlights: [
      ...
      { title: '白银周 9/19–23 最后预订窗口（本周新增）', body: '距白银周 8 天；9/18–23 期间东京—博多间所有 Nozomi 列车全车指定席，热门方向（京都、东京、冲绳）住宿 50% 以上已满且价格上涨 30–80%；建议本周内锁定机酒，否则考虑错峰或改道东北、四国、北陆等非热门目的地。' },
      { title: '红叶前线 9 月更新（本周新增）', body: '北海道大雪山系（旭岳·黑岳）已于 9 月初进入染色期，本州高山地带（立山、白山、燕岳）9 月中下旬起转色。2026 年关东平原红叶见顷预计 11 月下旬—12 月上旬。红叶前线按日本气象协会或气象厅每周更新，请以官方发布为准。' },
      { title: 'JR Pass 海外指定代理店 10/1 调整临近（本周新增）', body: '自 2026-10-01 起，海外指定代理店购入的 JR Pass 价格将调整，9/30 前完成购票可锁定当前价格（7 日 50,000 日元等档位）；JR 集团直营渠道（JR 车站、官网、JTB 等）不受本次调整影响。具体调价幅度、适用区间与币种以 japanrailpass.net 结算页与 JR 集团官方公告为准。' },
      { title: '首里城正殿 11/23 预约临近（本周新增）', body: '首里城公园官网已预告 2026-11-23 起的正殿内部一般公开安排，预计 10 月中旬起开放一般预约（含指定时段）。冲绳 11 月仍处台风季尾声，前往时同步关注那霸机场航班与海面状况。' },
      { title: '节假日闭馆与舆情提醒（本周新增）', body: '9/21 敬老之日、9/22 国民休息日、9/23 秋分之日、10/13 体育之日、11/3 文化之日、11/23 勤劳感谢之日，多数博物馆、商场调整营业或闭馆一日。岚山小火车秋季已恢复全线运行；富士山五合目吉田口 2026 官方开放期至 9/10，本周起封山整备。' }
    ],
    guides: [
      ...
      { emoji: '🛟', title: '遇到数据不确定时的降级输出', body: '官方 API 或公告未更新时，本文不会凭记忆补齐数据；请直接打开本页所列官方链接核实，并把酒店与交通的客服电话作为兜底。' },
    ],
