...
export const specialTopics = [
  ...
  },
  {
    ...
    facts: [
      { label: '最新核查', value: '2026-09-04', note: '对照 JR 九州 / JR 东海 / JR 东日本 / JNTO / 国税厅 / 首里城公园 / 石川县官方公告' },
      { label: '影响范围', value: '铁路（地震+白银周）、免税、机场', note: '⚠️ 本周新增：九州新干线停运恢复 / 白银周出行预警' },
      { label: '更新频率', value: '每周一次（本周维护：2026-09-04）', note: '每周维护与重新对照官方信息' },
    ],
    highlights: [
    ...
    guides: [
      ...
      { emoji: '📅', title: '生效时间先于金额', body: 'JR Pass 价格变动看 JR 集团公告，免税新规是 2026-11-01，首里城正殿一般公开为 2026-11-23；同一年里先后有多项政策与新设施生效。' },
      { emoji: '⚠️', title: '把官方链接收藏好', body: 'JR 东海与东日本、国税厅、首里城公园、石川县官方公告是这份情报的源头；攻略只做导览，不替代官方公告。' },
    ],
